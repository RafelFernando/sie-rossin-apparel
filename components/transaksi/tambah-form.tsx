...
import { saveTransaksi } from "@/lib/transaksi/action";
import { useTopLoader } from "nextjs-toploader";
import clsx from "clsx";
import Link from "next/link";

export default function TambahTransaksiForm() {
    const [state, formAction, isPending] = useActionState(saveTransaksi, null);
            ...
            <form action={formAction}>
                <div className="grid md:grid-cols-2 gap-1">
                    <div>
                        ...
                        <input type="text" name="customerId" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Customer ID*" />
                    ...
                    <div>
                        ...
                        <input type="date" name="transactionDate" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " />
                    </div>

                    <div className="md:col-span-2">
                        <label className="block mb-2 text-[18px] font-medium text-black">Product Category</label>
                        <select name="productCategory" defaultValue="" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light ">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="unitPrice" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Unit Price*" />
                        <div aria-live="polite" aria-atomic="true">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="quantity" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Quantity*" />
                        <div aria-live="polite" aria-atomic="true">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="totalAmount" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Total Amount*" />
                        <div aria-live="polite" aria-atomic="true">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="discountAmount" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Discount Amount*" />
                        <div aria-live="polite" aria-atomic="true">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <select name="paymentMethod" defaultValue="" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " >
                    ...
                    <div className="md:col-span-2">
                        ...
                        <select name="deviceType" defaultValue="" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " >
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="sessionDurationMinutes" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Session Duration Minutes*" />
                        <div aria-live="polite" aria-atomic="true">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="pagesViewed" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Pages Viewed*" />
                        <div aria-live="polite" aria-atomic="true">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="text" name="customerRating" className="bg-white p-3 border border-gray-200 rounded-sm w-full font-light " placeholder="Customer Rating*" />
                        <div aria-live="polite" aria-atomic="true">
